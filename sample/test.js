...
module.exports = function (url) {
    ...
    it('insertVar: staff[email] ( #staff_email, {{bbb}} )', async function(){
        await driver.sleep(300).wait('#staff_email', 30000)
               .val(_(`{{bbb}}`));
    });

    it('dblClick: staff[email] ( #staff_email, 346, 33, 0 )', async function(){
        await driver.sleep(300).wait('#staff_email', 30000)
               .sleep(300).mouseMove(346, 33).click(0).click(0);
    });

    it('click: staff[email] ( #staff_email, 346, 33, 0 )', async function(){
        await driver.sleep(300).wait('#staff_email', 30000)
               .sleep(300).mouseMove(346, 33).click(0);
    });
    ...
    it('insertVar: staff[email] ( #staff_email, {{cc}} )', async function(){
        await driver.sleep(300).wait('#staff_email', 30000)
               .val(_(`{{cc}}`));
    });

    it('click: staff[email] ( #staff_email, 210, 25, 0 )', async function(){
        await driver.sleep(300).wait('#staff_email', 30000)
               .sleep(300).mouseMove(210, 25).click(0);
    });

    it('click: staff[email] ( #staff_email, 147, 33, 0 )', async function(){
        await driver.sleep(300).wait('#staff_email', 30000)
               .sleep(300).mouseMove(147, 33).click(0);
    });
    ...
    it('click: div.container, 864, 88, 0', async function(){
        await driver.sleep(300).wait('div.container', 30000)
               .sleep(300).mouseMove(864, 88).click(0);
    });
            ...
            before(function () {
                ...
                try {
                    self.driver = driver.session(sessionConfig).windowSize(1024, 768).config({
                        pageloadTimeout: 60000, // page onload timeout
